...
and a paired median saving. The measurement script is `mechanism_study/run_ab.py`, in the
parent repository. This directory holds the captured natural orders and the emitted orders
for the six confirmed
